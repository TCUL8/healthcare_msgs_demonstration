...
- The default venv path is: `/home/tjalf/ros2_ws/src/-healthcare_demo/.venv`
- All scripts and launch commands should use the Python interpreter from this venv:
  
  ```bash
  /home/tjalf/ros2_ws/src/-healthcare_demo/.venv/bin/python <script.py>
  ```
- If you install new Python packages, always activate the venv or use the full path to `pip`:
  
  ```bash
  /home/tjalf/ros2_ws/src/-healthcare_demo/.venv/bin/pip install <package>
  ```
