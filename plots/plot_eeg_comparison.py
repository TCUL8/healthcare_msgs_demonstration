def plot_selected_channels(times, raw_eeg, preprocessed_eeg, channel_names, channels_to_plot):
    """
...
def plot_raw_vs_preprocessed(raw_data_path, preprocessed_data_path, channels_to_plot, seconds_to_plot=10, sampling_rate=256, num_channels=4, channel_names=None):
    """
    ...
    plot_selected_channels(times, raw_eeg, preprocessed_eeg, channel_names, channels_to_plot)
...
# Raw data is in logs/eeg_raw_data.jsonl
# Preprocessed data is in eeg_data/eeg_preprocessed_data.jsonl
RAW_DATA_PATH = os.path.join(LOGS_DIR, 'eeg_raw_data.jsonl')
...
if __name__ == "__main__":
    ...
    plot_raw_vs_preprocessed(RAW_DATA_PATH, PREPROCESSED_DATA_PATH, CHANNELS_TO_PLOT, seconds_to_plot=10)
